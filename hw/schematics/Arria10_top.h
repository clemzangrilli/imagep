...
$end;
$bind("Arria10_soc_inst->UART1_RX","Console1->RX");
vista_bind(Arria10_soc_inst->UART1_RX, Console1->RX);
$end;
$bind("Console1->TX","Arria10_soc_inst->UART1_TX");
vista_bind(Console1->TX, Arria10_soc_inst->UART1_TX);
$end;
$bind("Arria10_soc_inst->UART0_RX","Console0->RX");
vista_bind(Arria10_soc_inst->UART0_RX, Console0->RX);
$end;
$bind("Console0->TX","Arria10_soc_inst->UART0_TX");
vista_bind(Console0->TX, Arria10_soc_inst->UART0_TX);
$end;
    $elaboration_end;
  $vlnv_assign_begin;
