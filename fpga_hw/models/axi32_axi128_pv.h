...
#include "axi32_axi128_model.h"

using namespace tlm;

//This class inherits from the axi32_axi128_pv_base class
class axi32_axi128_pv : public axi32_axi128_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(axi32_axi128_pv);
  axi32_axi128_pv(sc_core::sc_module_name module_name);    
