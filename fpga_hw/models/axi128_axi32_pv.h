...
#include "axi128_axi32_model.h"

using namespace tlm;

//This class inherits from the axi128_axi32_pv_base class
class axi128_axi32_pv : public axi128_axi32_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(axi128_axi32_pv);
  axi128_axi32_pv(sc_core::sc_module_name module_name);    
